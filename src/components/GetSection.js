      ...
      <section className='get'>
         <div className='get__container'>
            <div className='get__body'>
               ...
               <Text text='Vade replaces legacy parking infrastructure with wireless cameras, computer vision, and granular analytics. We make it easy for cities to monitor and manage curb space in real-time.' />
               <Button buttonText='More about our technology' />
            </div>
